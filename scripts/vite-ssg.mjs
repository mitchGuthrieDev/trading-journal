  ...
  return {
    ...
    async buildStart() {
      const server = await createServer({
        ...
        // Mirror the main build's $lib alias so site/app modules that import the shared
        // design system + core resolve during prerender. The Tailwind plugin is NOT needed here:

  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        // Dev-only component reference (UI mockup workflow, Step 3). Built + deployed so it's always
        // reachable, but noindex + robots-blocked and never linked from the product.

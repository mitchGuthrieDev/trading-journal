<script lang="ts">
  import { Tooltip as TooltipPrimitive, type WithoutChild } from 'bits-ui';
  ...
  let {
    ...
    children,
    ...restProps
  }: WithoutChild<TooltipPrimitive.ContentProps> = $props();
</script>
...
<TooltipPrimitive.Portal>
  ...
  >
    {@render children?.()}
    <TooltipPrimitive.Arrow class="bg-primary z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px]" />
  </TooltipPrimitive.Content>
</TooltipPrimitive.Portal>
